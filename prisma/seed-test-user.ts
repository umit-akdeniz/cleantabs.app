...
async function createTestUser() {
  try {
    ...
    console.log('📧 Email: test@aetherion.app');
          ...
          if (j === 0) {
            ...
            for (let k = 0; k < 100; k++) {
              ...
              await prisma.site.create({
                data: {
                  id: `test-site-${i + 1}-${j + 1}-${k + 1}`,
                  name: siteName,
                  url: siteUrl,
                  description: `${siteTemplate.description} - Test Instance ${k + 1}`,
    ...
    console.log('1. Go to the app and login with the credentials above');
    console.log('2. Select "Development Tools" category');
    console.log('3. Select "Code Editors 1" subcategory');
    console.log('4. You will see 100 sites for scroll testing');
    console.log('5. Test mobile scroll functionality');
