...
import { Eye, EyeOff, Mail, Lock, User, Check, ArrowRight, Sparkles } from 'lucide-react';
...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:from-slate-950 dark:to-slate-900 dark:bg-gradient-to-br flex items-center justify-center p-4">
